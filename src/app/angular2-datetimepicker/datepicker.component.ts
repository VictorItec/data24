...
export class DatePicker implements OnInit, ControlValueAccessor {
    ...
    hourValue: number = this.timeViewDate.getHours();
    toHourValue: number = 0;
    minValue: number = this.timeViewDate.getMinutes();
    toMinValue: number = 0;
    ...
    defaultSettings: Settings = {
        ...
        cal_days_labels: ['Do', 'Se', 'Te', 'Qu', 'Qu', 'Se', 'Sá'],
    ...
    ngOnInit() {
        ...
        this.labelMonth = this.settings.cal_months_labels[this.today.getMonth()];
    ...
    prevMonth(e: any) {
        ...
        if (this.date.getMonth() == 0) {
            ...
            this.labelMonth = this.settings.cal_months_labels[0];
        } else {
            ...
            this.labelMonth = this.settings.cal_months_labels[this.date.getMonth()];
        }
        this.date = new Date(this.date);
        this.monthDays = this.generateDays(this.date);
    }
